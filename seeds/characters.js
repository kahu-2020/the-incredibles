  ...
  knex('characters').del()
    .then(() =>
      knex('characters').insert([
        ...
        { id: 11, name: 'Nemo', voice_actor: 'Alexander Gould', quote: '\"The water is half empty!\" \"Hmmmm. Really? I\'d say it\'s half full\"', movie_id: 3 },

        { id: 12, name: 'Hamm', voice_actor: 'John Ratzenberger', quote: 'Hey, why did the toys cross the road', movie_id: 1 },
      ]))
